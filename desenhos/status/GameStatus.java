...
public class GameStatus extends Status {
    ...
    public GameStatus(Game game){
        ...
        Bola.bolas.add(new Bola(100, 80, 50, 2, -84, Color.RED));
        Bola.bolas.add(new Bola(300, 170, 70, 2, -42, Color.YELLOW));
        Bola.bolas.add(new Bola(500, 170, 90, 2, 60, Color.GREEN));
    }
